# ============================================================
# 1D NONLINEAR UKF — EXAMPLE 2
# ============================================================
#
# Goal:
# Estimate a hidden 1D state x from a nonlinear noisy sensor.
#
# Initial belief:
#     x ~ N(2.0, 0.25)
#
# Nonlinear dynamics:
#     x_next = 0.8*x + 0.2*x^2 + process_noise
#     Q = 0.01
#
# Nonlinear measurement:
#     z = x^2 + measurement_noise
#     R = 0.04
#
# Actual measurement:
#     z = 5.2
...
#
# Goal:
#     Predict the state through nonlinear dynamics,
#     predict the nonlinear measurement,
#     and update the state using the measurement.
#
# ============================================================
import numpy as np
